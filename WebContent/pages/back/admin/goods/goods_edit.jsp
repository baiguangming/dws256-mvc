				...
				<form action="<%=GOODS_EDIT_URL%>" method="post" class="form-horizontal" id="goodsForm" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="form-group" id="tagDiv">
							...
							<div class="col-md-5">
								<%
								Iterator<Tag> taIterator = allTags.iterator();
									while(taIterator.hasNext()){
										Tag tag = taIterator.next();
							%>
								<div class="col-md-3">
									<div class="checkbox">
						...
						<div class="form-group" id="photoDiv">
							...
							<div class="col-md-5">
								<img src="upload/goods/<%=goods.getName()%>" style="width:200px"><br>
						...
						<div class="form-group">
							<div class="col-md-3 col-md-offset-3">
								...
								<input type="hidden" id="oldphoto" value="<%=goods.getPhoto()%>">
